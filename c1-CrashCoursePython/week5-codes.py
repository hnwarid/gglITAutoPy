# These are codes from the first practice quiz
...
# by George Bernard Shaw, using objects to represent people.
...
# Fill in the blanks of the max_elevation_city function to return the name of the city
# and its country (separated by a comma), when comparing the 3 defined instances for
# a specified minimal population. For example, calling the function for a minimum population
# of 1 million: max_elevation_city(1000000) should return "Sofia, Bulgaria".
...
# so that the describe_furniture function can format a sentence that
